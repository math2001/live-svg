...
function showHelp() {
    ...
    console.error('  $ live-svg -> Starts the server on port 8000')
    console.error('  $ live-svg mysvg.svg -> Starts the server in the CWD and')
    console.error('                          open mysvg.svg in the browser')
    console.error()
